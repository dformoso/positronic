...
`${CLAUDE_SKILL_DIR}/../../../docs/selection-method.md` — the shared method: core principles, the verify-at-decision-time checklist, the disqualifiers, the agent-workload wrinkles, and the full development-to-production path. This skill *executes* that method one category at a time; it does not restate it. If the doc and this skill ever disagree, the doc wins.
