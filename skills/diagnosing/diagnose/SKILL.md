...
10. **HITL bash script.** Last resort. If a human must click, drive _them_ with `${CLAUDE_SKILL_DIR}/scripts/hitl-loop.template.sh` so the loop is still structured. Captured output feeds back to you.
