...
This skill reads `CONTEXT.md` and `docs/adr/` if they exist. Domain language names good seams; ADRs record past decisions — don't re-litigate them. See [CONTEXT-FORMAT.md](../grill-with-docs/CONTEXT-FORMAT.md) and [ADR-FORMAT.md](../grill-with-docs/ADR-FORMAT.md).
