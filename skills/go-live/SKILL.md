...
| Schema-change contract honored — the previous release boots against the migrated store (expand/contract) | the boot-the-previous-image proof (see `${SKILL_DIR}/../to-spec/rollout.md`) | |
